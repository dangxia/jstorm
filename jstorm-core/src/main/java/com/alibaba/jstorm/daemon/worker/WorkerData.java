...
public class WorkerData {
	...
	public WorkerData(Map conf, IContext context, String topology_id, String supervisor_id, int port, String worker_id,
	 ...
	 * HashMap<Integer, String> tasksToComponent; private Map<String, List
	 * <Integer>> componentToSortedTasks; private Map<String, Map<String,
